...
# Model 2: LSTM with secondary input concatenated before the LSTM layer
...
# Model 3: LSTM with secondary input added after LSTM layer
...
class LSTMX1_X2Masking(nn.Module):
    def __init__(self, input_dim, hidden_size, num_layers, output_dim, auxiliary_input_dim):
        ...
        self.lstm = nn.LSTM(input_dim + 1 , hidden_size, num_layers, batch_first=True)
