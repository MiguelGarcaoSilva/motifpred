...
run_optuna_study(pipeline.run_cross_val, TimeSeriesTransformer, model_type, suggestion_dict, model_params_keys, seed, [X_series], y, result_dir, n_trials=n_trials, num_epochs=num_epochs)
...
run_optuna_study(pipeline.run_cross_val, TimeSeriesTransformer, model_type, suggestion_dict, model_params_keys, seed, [X_series, X_mask], y, result_dir, n_trials=n_trials, num_epochs=num_epochs)
...
run_optuna_study(pipeline.run_cross_val, TimeSeriesTransformer, model_type, suggestion_dict, model_params_keys, seed, [X_indices], y, result_dir, n_trials=n_trials, num_epochs=num_epochs)
