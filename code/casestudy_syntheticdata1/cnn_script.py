...
#run_optuna_study(pipeline.run_cross_val, CNN, model_type, suggestion_dict, model_params_keys, seed, X1, X_mask, y, model_results_dir, n_trials=n_trials, num_epochs=num_epochs)
